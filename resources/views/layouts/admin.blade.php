    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <a href="{{ route('admin.products.index') }}" class="font-semibold text-3xl text-blue-400 pl-4">น้ำดื่ม<br>หยาดทิพย์</a>
            ...
            <nav :class="{ 'block': open, 'hidden': !open }"
                ...
                {{-- <div class="mb-4 px-4">
                    ...
                    <div
                        ...
                        <a href="{{ route('admin.payments.panel') }}"
                            :active="request() - > routeIs('admin.payments.panel')">
                            {{ __('Payments') }}
                        </a>
                    </div>
                    <div
                ...
                <div class="mb-4 px-4">
                    <p class="pl-4 text-sm font-semibold mb-1">รายการสินค้า</p>
                    <div
                        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
                        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                            <path
                    ...
                    <div
                        ...
                        <a href="{{ route('admin.villages.index') }}"
                            :active="request() - > routeIs('admin.villages.index')">
                            {{ __('หมู่บ้าน') }}
                        </a>
                    </div>
                    <div
                ...
                <div class="mb-4 px-4">
                    <p class="pl-4 text-sm font-semibold mb-1">อื่นๆ</p>
                    {{-- <div
                        class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
                        <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                            <path
                    ...
                    <div
                        ...
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            ...
                            <a link href="{{ route('logout') }}" @click.prevent="$root.submit();">
                                {{ __('ออกจากระบบ') }}
                            </a>
                        </form>
                    </div>
        ...
        <main class="mx-auto w-full p-2">
            <div class="py-4">
                ...
                @if (session()->has('warning'))
                    <div class="p-4 mb-4 bg-yellow-100 border-t border-b border-yellow-500 text-yellow-700 px-4 py-3" role="alert">
