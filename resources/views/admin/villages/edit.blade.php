        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                    <p class="font-semibold text-3xl text-blue-400 pl-4">แก้ไขหมู่บ้าน</p>
                </div>
                    ...
                    <div class="mt-10 w-full space-y-8 divide-y divide-gray-200">
                        <form method="POST" action="{{ route('admin.villages.update', $village->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="sm:col-span-6">
                                <label for="name" class="block text-sm font-medium text-gray-700"> ชื่อหมู่บ้าน </label>
                                <div class="mt-1">
                                    <input type="text" id="name" name="name" value="{{ $village->name }}"
