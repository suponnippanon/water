    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <p class="font-semibold text-3xl text-blue-400 pl-4">แก้ไขสินค้า</p>

                <div class="flex justify-end m-2 p-2">
                    <a href="{{ route('admin.products.index') }}"
                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">หน้าสินค้า</a>
                </div>
            </div>
            ...
            <div class="m-2 rounded bg-slate-50 p-2">
                <div class="mt-10 w-full space-y-8 divide-y divide-gray-200">
                    <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <div>
                                    <img class="w-32 h-32 py-2" src="{{ asset($product->image) }}">
                                </div>
                                <br>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" min="0.00" max="10000.00" step="1.00" id="price" name="price" value="{{ $product->price }}"
                                    class="block w-full appearance-none rounded-md border border-gray-400 bg-white py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 focus:border-indigo-500 focus:ring-indigo-500" />
                            </div>
                        </div>
                ...
                <div class="mt-6 p-4 text-right">
                    <button type="submit"
                        class="rounded-lg bg-green-500 px-4 py-2 text-white hover:bg-green-700">อัพเดต</button>
                </div>
                </form>
            </div>
        </div>
