<x-guest-layout>
    ...
    <div class="mt-4 text-center">
        ...
        <h2 class="bg-white bg-clip-text text-3xl font-bold text-transparent">สินค้า</h2>
    </div>
    ...
    <section class="mt-8 bg-gradient-to-r  from-zinc-900 via-indigo-900 to-zinc-900 w-full h-full">
        <div class="container mx-auto w-full px-5 py-6">
          <div class="grid gap-y-6 lg:grid-cols-4">
            ...
            <div class="mx-3 flex h-96 flex-col items-center justify-around overflow-hidden rounded-3xl bg-white shadow-md sm:h-52 sm:w-3/5 sm:flex-row md:w-80 hover:bg-blue-100">
              <img class="h-1/2 w-full object-cover sm:h-full sm:w-1/2" src="{{asset($product->image)}}" alt="image" />
      
              <div class="flex h-1/2 w-full flex-1 flex-col items-baseline justify-around pl-6 sm:h-full sm:w-1/2 sm:items-baseline">
                <div class="flex flex-col items-baseline justify-start">
                  <a href="{{ route('products.details', $product->id) }}" class="mb-0 font-sans text-lg font-normal text-gray-600">{{ $product->name }}</a>
                  <a href="{{ route('products.details', $product->id) }}" class="mt-0 text-xs text-indigo-300">{{ $product->category->name }}</a>
                </div>
                <p class="w-4/5 text-xs text-gray-500"> {{ Str::limit($product->description, 60, "...") }}</p>
            ...
            <div class="flex flex-wrap items-center sm:-mx-3">
                <div class="w-full md:w-1/2 md:px-3">
                    <div class="w-full pb-6 space-y-4 sm:max-w-md lg:max-w-lg lg:space-y-4 lg:pr-0 md:pb-0">
                        ...
                        <h2 class="text-2xl font-extrabold tracking-tight text-white sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">น้ำดื่มหยาดทิพย์</h2>
        ...
        <div class="container items-center max-w-6xl px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                     ...
                     class="text-2xl font-extrabold tracking-tight text-white sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl"
                        ...
                        <ul>
                            ...
                            class="text-2xl font-extrabold tracking-tight text-white sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl"
                               ...
                               <p class="mx-auto text-base text-white sm:max-w-md lg:text-xl md:max-w-3xl">
                                <br>
                                <a href="https://www.facebook.com/profile.php?id=100083366259713" type="button" class="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 mr-2 mb-2">
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                        ...
                        src="{{asset('storage/template/address.jpg')}}"
