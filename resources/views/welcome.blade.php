<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image:  url('{{asset('storage/template/water.jpg')}}')">
        <h1
    ...
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
          ...
          <h2 class="bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-3xl font-bold text-transparent">TODAY'S SPECIALITY</h2>
        </div>
            ...
            <div class="mx-3 flex h-96 flex-col items-center justify-around overflow-hidden rounded-3xl bg-white shadow-md sm:h-52 sm:w-3/5 sm:flex-row md:w-80 hover:bg-blue-100">
              ...
              <div class="flex h-1/2 w-full flex-1 flex-col items-baseline justify-around pl-6 sm:h-full sm:w-1/2 sm:items-baseline">
                <div class="flex flex-col items-baseline justify-start">
                  <h1 class="mb-0 font-sans text-lg font-normal text-gray-600">{{ $product->name }}</h1>
                  <span class="mt-0 text-xs text-indigo-300">{{ $product->category->name }}</span>
                </div>
                ...
                <div class="flex w-full items-center justify-between">
                  ...
                  <button class="mr-5 rounded-sm bg-green-400 hover:bg-green-700 px-3 py-1 text-white shadow-md">Add</button>
                </div>
              </div>
            </div>
            @endforeach
            ...
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                    <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
                        src="{{ asset('storage/template/water.jpg') }}">
                </div>
                <div>
